...
- Wallix Bastion will manage privileged sessions.
...
- A dedicated IAM Consultant oversees the end-to-end process documentation.
- End users will participate in MFA adoption and access certification campaigns.

## Risk-Based Assumptions
If any of these assumptions fail (e.g., unstable API integration or incomplete HR data), the IAM scope and timelines may be adjusted through a Change Control process.
