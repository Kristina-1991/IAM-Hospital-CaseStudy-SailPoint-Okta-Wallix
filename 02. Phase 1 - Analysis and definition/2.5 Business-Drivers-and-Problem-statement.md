...
- **No end-to-end identity lifecycle control**  
   Clinical user accounts are created and modified on demand. Accounts are often not revoked on time when a contract ends or a function changes. For administrative staff roles, user accounts are shared. 
