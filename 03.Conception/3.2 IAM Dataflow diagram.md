...
## IGA → IDP (Identity Federation Flow)
**Description:**  
...
## IGA → Applications (Access Provisioning Flow)
**Description:**  
...
## IDP → Applications (Authentication Flow)
**Description:**  
...
## PAM → Infrastructure & APIs (Privileged Access Flow)
**Description:**  
